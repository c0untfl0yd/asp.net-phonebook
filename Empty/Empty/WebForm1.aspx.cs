    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        public string getData() {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    ...
                    htmlstring += "<tr><td>" + "{*'\"" + val1 + "</td><td>" + val2 + "</td><td>" + val3 + "</td></tr>";
            ...
            {
                Response.Write("<script>alert(\"A problem occured reading the Data. Please check back in a while.\");</script>");
            }
            finally
            {
                conn.Close();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCeCommand cmd = new SqlCeCommand("INSERT INTO People(NAME, PHONE) VALUES (@NAME, @PHONE)", conn);
                ...
                {
                    Response.Write("<script>alert(\"A problem occured submitting the Data. Contact names are Unique.\");</script>");
                }
                finally
                {
                    conn.Close();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert(\"A problem occured during deletion.\");</script>");
            }
            finally
            {
                conn.Close();
